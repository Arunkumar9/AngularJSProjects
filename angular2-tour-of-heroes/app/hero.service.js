...
var HeroService = (function () {
    function HeroService(http) {
        this.http = http;
        this.employeesUrl = 'http://localhost/AngularJSProjects/AngularPHP/AngularMySqlConnection.php'; // URL to web API
        this.heroesUrl = 'app/heroes';
        this.headers = new http_1.Headers({ 'Content-Type': 'applictation/json' });
        this.http = http;
    }
    ...
    HeroService.prototype.createHero = function (id, name) {
